...
const Section1 = () => {
  ...
  return isMobile ? (
    <>
      ...
      <div className='bg-sky-600 h-28 w-full mb-10 rounded-lg flex flex-col items-center justify-evenly'>
        <h1 className='text-white text-4xl'>ESCOLHA SUA FORMA DE ENTREGA</h1>
